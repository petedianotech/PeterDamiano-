...
export default function Navbar() {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 md:px-12 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8">
          ...
          <a
            ...
            className="flex items-center gap-2 bg-[#25D366]/10 text-[#25D366] border border-[#25D366]/20 px-4 py-2 rounded-full text-sm font-medium hover:bg-[#25D366] hover:text-white transition-all duration-300"
          >
      ...
      {/* Mobile Side Drawer */}
      <div
        className={`fixed top-0 right-0 bottom-0 w-[280px] bg-[#0a0a0a] border-l border-white/10 z-[70] transition-transform duration-500 md:hidden ${
